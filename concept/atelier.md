...
- the **routing table**, the framework's 2 questions (static or dynamic? what is it?) turned into a concrete table in the core's `AGENTS.md`: every type of thing has its home, and nothing gets created outside the table;
...
- Template: [templates/chantier/](../implementation/mos/templates/workstream/About.template.md); the generic routing table lives in [AGENTS.md](../implementation/mos/AGENTS.md).
